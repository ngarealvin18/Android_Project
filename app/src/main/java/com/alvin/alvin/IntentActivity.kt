...
fun Intent() {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val intent =
                    android.content.Intent(android.content.Intent.ACTION_CALL, Uri.parse("tel:" + "+254758592717"))
        ...
        OutlinedButton(
            onClick = {
                val uri = Uri.parse("smsto:0721863427")
        ...
        OutlinedButton(
            onClick = {
                val phone = "+254758592717"

                val intent =
                    android.content.Intent(android.content.Intent.ACTION_DIAL, Uri.fromParts("tel", phone, null))
        ...
        OutlinedButton(
            onClick = {
                val calculatorLaunchIntent =
                    context.packageManager.getLaunchIntentForPackage("com.android.calculator")

                calculatorLaunchIntent?.let { context.startActivity(it) }
            },
            colors = ButtonDefaults.buttonColors(Color.Blue),
            shape = RoundedCornerShape(16.dp),
            modifier = Modifier.fillMaxWidth()
